    ...
    setTimeout(() => {
      setResult({
        ...
        reasoning: [
          ...
          "Відсутні ознаки маніпулятивної емоційності, притаманної пропаганді."
        ]
      });
              ...
              <>
                <div className="h-48 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center flex-col">
                    <span className="text-4xl font-black text-[#00f2fe]">98.5%</span>
                    <span className="text-[10px] text-slate-500 uppercase">Confidence</span>
                  </div>
                </div>
                <div className="mt-6 py-2 px-6 rounded-full inline-block text-xs font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                  ВЕРДИКТ: {result.verdict}
                </div>
              </>
            ) : (
              <div className="py-20 text-slate-600 italic text-sm">Очікування аналізу...</div>
            )}
          </div>
        </div>
      </main>
