      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-3xl">
            <h2 className="text-slate-400 text-sm font-semibold mb-4 uppercase">Аналіз контенту</h2>
            <textarea 
            ...
            <button 
              ...
              className="w-full mt-6 bg-[#00f2fe] text-black font-black py-4 rounded-2xl hover:scale-[1.01] transition-all disabled:opacity-30"
            >
          ...
          {result && (
            <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-3xl">
              <h2 className="text-slate-400 text-sm font-semibold mb-4 uppercase tracking-widest">Сліди міркувань</h2>
        ...
        <div className="bg-slate-900/40 border border-slate-800 p-8 rounded-3xl text-center h-fit">
          <h2 className="text-slate-400 text-sm font-semibold mb-6 uppercase tracking-widest">Результат</h2>
          {result ? (
